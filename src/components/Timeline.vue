<template>
    <div class="timeline h-100 d-flex flex-column position-relative">
        ...
        <div class="d-flex h-100 overflow-hidden">
            ...
            <div class="h-100 w-100 overflow-x-auto d-flex flex-column timeline-scroll-container position-relative"
                ...
                <timeline-playhead :scroll-container="timelineScrollContainerRef"></timeline-playhead>
            </div>
        </div>
